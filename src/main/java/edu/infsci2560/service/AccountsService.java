 ...
 */
@RestController
@RequestMapping("/public/api/accounts")
public class AccountsService {
    ...
    public ResponseEntity<Account> list(@PathVariable("id") Long id) {
        HttpHeaders headers = new HttpHeaders();
    ...
    public ResponseEntity<Account> create(@RequestBody Account account) {
        HttpHeaders headers = new HttpHeaders();
        return new ResponseEntity<>(repository.save(account), headers, HttpStatus.OK);
    }
}